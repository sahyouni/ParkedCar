...
public class ParkedCar {
     ...
     */
    public ParkedCar(String inputOwnerName, String inputMake, int inputModelYear, String inputLicensePlateNumber, int inputMinutesParked) {

        // start with the validation. If any of the validations fail, throw an exception.
        //throwing an exception will cause the execution of the subsequent statements to NOT run.
        //i have inverted the conditionals to make the code more readable since we have less branching now
       ...
       //assign local variables after validation
    ...
    public void setOwnerName(String inputName) {
       ...
       //invert the condition. This way you don't need an else and the code is more readable
        if(inputName ==null){
            throw new IllegalArgumentException("owner name cannot be null");
        }
        ownerName = inputName;
     ...
     * 
     * @param inputLicensePlateNumber A parameter to set car license plate number
     *                                value
     */
